...
CREATE TABLE telemetria (
	...
	mision_id BIGSERIAL NOT NULL REFERENCES mision(id)
);
...
CREATE TABLE espectros (
	...
	capturado VARCHAR[],
	resultado VARCHAR[],
	sensores_id BIGSERIAL NOT NULL REFERENCES sensores(id)
);
...
CREATE TABLE espway (
    ...
    CONSTRAINT espectros_fkey FOREIGN KEY (espectros_id) REFERENCES espectros(id),
    CONSTRAINT waypoints_fkey FOREIGN KEY (waypoints_id) REFERENCES waypoints(id)
);
